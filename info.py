...
BOT_TOKEN = environ.get('BOT_TOKEN', "8507673108:AAGpFPvih2uZnQNN3lhNW-w75Uuo8yN3xTQ")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/e7lyy0.jpg')).split()  # Sample pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003275161245').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002977781361'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002977781361'))  # Bin channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003176397815')  # Support group id (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002700105454'))  # Notification of sent to your channel
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/FtCinema_bot') # Update channel link for the bot
